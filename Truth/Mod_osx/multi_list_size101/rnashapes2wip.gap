...
iloop [n] = [n]sp(|1|<1 BASE>, |1|<1 BASE>, |n|[n]il(|1|<1 REGION>, |1|<1 closed>, |1|<1 REGION>, ), |1|<1 BASE>, |1|<1 BASE>, ) | 

initstem [1] = [1]is(|1|<1 closed>, ) | 

leftB [n] = [n]sp(|1|<1 BASE>, |1|<1 BASE>, |n|[n]bl(|1|<1 REGION>, |1|<1 initstem>, ), |1|<1 BASE>, |1|<1 BASE>, ) | 
...
rightB [n] = [n]sp(|1|<1 BASE>, |1|<1 BASE>, |n|[n]br(|1|<1 initstem>, |1|<1 REGION>, ), |1|<1 BASE>, |1|<1 BASE>, ) | 
...
closed [1] = <1 stack> | <1 hairpin> | <9 multiloop> | <n leftB> | <n rightB> | <n iloop> | 
