...
subgraph cluster_18{
node_203 [ label=<<table border='0'><tr><td>front_Pr</td></tr></table>>, color="black", shape="box", style="dotted" ];
...
subgraph cluster_22{
node_249 [ label=<<table border='0'><tr><td>back_Pr</td></tr></table>>, color="black", shape="box" ];
