digraph Cm {
  ...
  subgraph cluster_5 {
    peripheries=1;
    label="";
    node_79 [ label=<<table border='0'><tr><td>d_4</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_7 {
    peripheries=1;
    label="";
    node_113 [ label=<<table border='0'><tr><td>ml_6</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_26 {
    peripheries=1;
    label="";
    node_436 [ label=<<table border='0'><tr><td>d_25</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
  ...
  subgraph cluster_29 {
    peripheries=1;
    label="";
    node_487 [ label=<<table border='0'><tr><td>d_28</td></tr></table>>, color="#0c0a0c", shape="box" ];
