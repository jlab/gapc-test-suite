...
node_15 [ label=<<table border='0'><tr><td><font point-size='8' color='#555555'>t_0_i<br/>t_1_i</font></td><td>bp</td><td><font point-size='8' color='#555555'>t_0_j<br/>t_1_j</font></td></tr></table>>, color="black", shape="box" ];
node_16 [ label=<<table border='0'><tr><td><font point-size='8' color='#555555'>t_0_i<br/>t_1_i</font></td><td>pair</td><td><font point-size='8' color='#555555'>t_0_j<br/>t_1_j</font></td></tr></table>>, color="green" ];
...
node_20 [ label=<<table border='0'><tr><td><font point-size='8' color='#555555'>t_1_i</font></td><td>BASE</td><td><font point-size='8' color='#555555'>(t_1_i + 1)</font></td></tr></table>>, color="blue" ];
node_19 -> node_20 [ style="invis" ];
};
node_16 -> node_19 [ arrowhead=none , lhead=cluster_node_18 ];
node_21 [ label=<<table border='0'><tr><td><font point-size='8' color='#555555'>(t_0_i + 1)<br/>(t_1_i + 1)</font></td><td>struct</td><td><font point-size='8' color='#555555'>(t_0_j - 1)<br/>(t_1_j - 1)</font></td></tr></table>>, color="black" ];
node_16 -> node_21 [ arrowhead=none ];
subgraph cluster_node_22 {
node_23 [ label=<<table border='0'><tr><td><font point-size='8' color='#555555'>(t_0_j - 1)</font></td><td>BASE</td><td><font point-size='8' color='#555555'>t_0_j</font></td></tr></table>>, color="blue" ];
node_24 [ label=<<table border='0'><tr><td><font point-size='8' color='#555555'>(t_1_j - 1)</font></td><td>BASE</td><td><font point-size='8' color='#555555'>t_1_j</font></td></tr></table>>, color="blue" ];
