digraph matrixmult {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>matrices</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3 ];
    node_1 -> node_2 [ style="invis", weight=99 ];
    node_2 [ label=<<table border='0'><tr><td><font point-size='30'>&rarr;</font></td></tr></table>>, shape=plaintext ];
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>mult</td></tr></table>>, color="#14fe14" ];
      node_4 [ label=<<table border='0'><tr><td>matrices</td></tr></table>>, color="#0c0a0c" ];
      node_3 -> node_4 [ arrowhead=none ];
      node_5 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="#0c0a0c" ];
      node_3 -> node_5 [ arrowhead=none ];
      node_6 [ label=<<table border='0'><tr><td>matrices</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_8 {
      peripheries=0;
      node_8 [ label=<<table border='0'><tr><td>single</td></tr></table>>, color="#14fe14" ];
      node_9 [ label=<<table border='0'><tr><td>boxl</td></tr></table>>, color="#0c0a0c" ];
      node_8 -> node_9 [ arrowhead=none ];
      node_10 [ label=<<table border='0'><tr><td>INT</td></tr></table>>, color="#0402fc" ];
      node_8 -> node_10 [ arrowhead=none ];
      node_11 [ label=<<table border='0'><tr><td>by</td></tr></table>>, color="#0c0a0c" ];
      node_8 -> node_11 [ arrowhead=none ];
      node_12 [ label=<<table border='0'><tr><td>INT</td></tr></table>>, color="#0402fc" ];
      node_8 -> node_12 [ arrowhead=none ];
      node_13 [ label=<<table border='0'><tr><td>boxr</td></tr></table>>, color="#0c0a0c" ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_16 [ label=<<table border='0'><tr><td>boxl</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_19 [ label=<<table border='0'><tr><td>boxr</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_22 [ label=<<table border='0'><tr><td>by</td></tr></table>>, color="#0c0a0c", shape="box" ];
    ...
    subgraph cluster_alt_24 {
      peripheries=0;
      node_24 [ label=<<table border='0'><tr><td>CHAR('x')</td></tr></table>>, color="#0402fc" ];
    };
  ...
  subgraph cluster_5 {
    peripheries=1;
    label="";
    node_25 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="#0c0a0c", shape="box" ];
