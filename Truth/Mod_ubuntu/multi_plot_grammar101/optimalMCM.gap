...
subgraph cluster_2{
    ...
    node_14 -> node_16 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_3{
    ...
    node_18 -> node_20 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_4{
    ...
    node_22 -> node_24 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_5{
    ...
    node_26 -> node_28 [ arrowhead=none, color="purple", weight=99, style=invis ];
