digraph flow {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      ...
      node_4 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="#0402fc" ];
      node_3 -> node_4 [ arrowhead=none ];
      node_5 [ label=<<table border='0'><tr><td>NON</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_7 {
      peripheries=0;
      node_7 [ label=<<table border='0'><tr><td>ti</td></tr></table>>, color="#14fe14" ];
      node_8 [ label=<<table border='0'><tr><td>NON</td></tr></table>>, color="#0402fc" ];
      node_7 -> node_8 [ arrowhead=none ];
      node_9 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_11 {
      peripheries=0;
      node_11 [ label=<<table border='0'><tr><td>ins</td></tr></table>>, color="#14fe14" ];
      node_12 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
      node_11 -> node_12 [ arrowhead=none ];
      node_13 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="#0402fc" ];
      node_11 -> node_13 [ arrowhead=none ];
      node_14 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="#0402fc" ];
      ...
      node_16 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_18 {
      peripheries=0;
      node_18 [ label=<<table border='0'><tr><td>del</td></tr></table>>, color="#14fe14" ];
      node_19 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="#0402fc" ];
      node_18 -> node_19 [ arrowhead=none ];
      node_20 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="#0402fc" ];
      node_18 -> node_20 [ arrowhead=none ];
      node_21 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_25 {
      ...
      node_26 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="#0402fc" ];
      node_25 -> node_26 [ arrowhead=none ];
      node_27 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_30 {
      peripheries=0;
      node_30 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="#14fe14" ];
      node_31 [ label=<<table border='0'><tr><td>NON</td></tr></table>>, color="#0402fc" ];
