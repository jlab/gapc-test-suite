digraph mopt {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>matrix</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3 ];
    node_1 -> node_2 [ style="invis", weight=99 ];
    node_2 [ label=<<table border='0'><tr><td><font point-size='30'>&rarr;</font></td></tr></table>>, shape=plaintext ];
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>mult</td></tr></table>>, color="#14fe14" ];
      node_4 [ label=<<table border='0'><tr><td>matrix</td></tr></table>>, color="#0c0a0c" ];
      node_3 -> node_4 [ arrowhead=none ];
      node_5 [ label=<<table border='0'><tr><td>matrix</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_7 {
      peripheries=0;
      node_7 [ label=<<table border='0'><tr><td>single</td></tr></table>>, color="#14fe14" ];
      node_8 [ label=<<table border='0'><tr><td>INT</td></tr></table>>, color="#0402fc" ];
