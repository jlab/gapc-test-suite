digraph bill {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_8 {
      peripheries=0;
      node_8 [ label=<<table border='0'><tr><td>add</td></tr></table>>, color="green" ];
      node_9 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
      node_8 -> node_9 [ arrowhead=none ];
      node_10 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_13 {
      peripheries=0;
      node_13 [ label=<<table border='0'><tr><td>number</td></tr></table>>, color="black" ];
    };
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_16 [ label=<<table border='0'><tr><td>number</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_18 {
      peripheries=0;
      node_18 [ label=<<table border='0'><tr><td>f</td></tr></table>>, color="green" ];
      node_19 [ label=<<table border='0'><tr><td>CONST_RATIO(Rational("1/4"))</td></tr></table>>, color="blue" ];
