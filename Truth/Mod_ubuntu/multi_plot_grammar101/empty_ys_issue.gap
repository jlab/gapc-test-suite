digraph gra_ok {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      ...
      node_4 [ label=<<table border='0'><tr><td>state_E_12</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_6 {
      peripheries=0;
      node_6 [ label=<<table border='0'><tr><td>silent_transition</td></tr></table>>, color="#14fe14" ];
      node_7 [ label=<<table border='0'><tr><td>state_MP_3</td></tr></table>>, color="#0c0a0c" ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_10 [ label=<<table border='0'><tr><td>state_MP_3</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_12 {
      peripheries=0;
      node_12 [ label=<<table border='0'><tr><td>pair_transition</td></tr></table>>, color="#14fe14" ];
      node_13 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
      node_12 -> node_13 [ arrowhead=none ];
      node_14 [ label=<<table border='0'><tr><td>state_E_12</td></tr></table>>, color="#0c0a0c" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_18 [ label=<<table border='0'><tr><td>state_E_12</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
