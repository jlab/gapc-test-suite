digraph nussinov {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_11 {
      ...
      node_12 [ label=<<table border='0'><tr><td>EMPTY</td></tr></table>>, color="#0402fc" ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_15 [ label=<<table border='0'><tr><td>bp</td></tr></table>>, color="#0c0a0c", shape="box" ];
    ...
    subgraph cluster_alt_17 {
      peripheries=0;
      node_17 [ label=<<table border='0'><tr><td>pair</td></tr></table>>, color="#14fe14" ];
