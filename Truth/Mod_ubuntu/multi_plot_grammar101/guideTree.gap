digraph guideTree {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3, style="dotted" ];
    node_1 -> node_2 [ style="invis", weight=99 ];
    node_2 [ label=<<table border='0'><tr><td><font point-size='30'>&rarr;</font></td></tr></table>>, shape=plaintext ];
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>Root</td></tr></table>>, color="#14fe14" ];
      node_4 [ label=<<table border='0'><tr><td>s</td></tr></table>>, color="#0c0a0c" ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_7 [ label=<<table border='0'><tr><td>s</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_9 {
      peripheries=0;
      node_9 [ label=<<table border='0'><tr><td>End</td></tr></table>>, color="#14fe14" ];
    ...
    subgraph cluster_alt_12 {
      peripheries=0;
      node_12 [ label=<<table border='0'><tr><td>p</td></tr></table>>, color="#0c0a0c" ];
    };
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_15 [ label=<<table border='0'><tr><td>p</td></tr></table>>, color="#0c0a0c", shape="box" ];
    ...
    subgraph cluster_alt_17 {
      peripheries=0;
      node_17 [ label=<<table border='0'><tr><td>Bif</td></tr></table>>, color="#14fe14" ];
      node_18 [ label=<<table border='0'><tr><td>BegL</td></tr></table>>, color="#14fe14" ];
      node_19 [ label=<<table border='0'><tr><td>p</td></tr></table>>, color="#0c0a0c" ];
      node_18 -> node_19 [ arrowhead=none ];
      node_17 -> node_18 [ arrowhead=none ];
      node_20 [ label=<<table border='0'><tr><td>BegR</td></tr></table>>, color="#14fe14" ];
      node_21 [ label=<<table border='0'><tr><td>p</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_23 {
      peripheries=0;
      node_23 [ label=<<table border='0'><tr><td>MatR</td></tr></table>>, color="#14fe14" ];
      node_24 [ label=<<table border='0'><tr><td>s</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_27 {
      peripheries=0;
      node_27 [ label=<<table border='0'><tr><td>MatL</td></tr></table>>, color="#14fe14" ];
      node_28 [ label=<<table border='0'><tr><td>CHAR('.')</td></tr></table>>, color="#0402fc" ];
      node_27 -> node_28 [ arrowhead=none ];
      node_29 [ label=<<table border='0'><tr><td>s</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_31 {
      peripheries=0;
      node_31 [ label=<<table border='0'><tr><td>MatP</td></tr></table>>, color="#14fe14" ];
      node_32 [ label=<<table border='0'><tr><td>CHAR('(')</td></tr></table>>, color="#0402fc" ];
      node_31 -> node_32 [ arrowhead=none ];
      node_33 [ label=<<table border='0'><tr><td>s</td></tr></table>>, color="#0c0a0c" ];
