digraph pal {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>pl</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3, style="dotted" ];
    ...
    subgraph cluster_alt_6 {
      peripheries=0;
      node_6 [ label=<<table border='0'><tr><td>match</td></tr></table>>, color="#14fe14" ];
      ...
      node_9 [ label=<<table border='0'><tr><td>pl</td></tr></table>>, color="#0c0a0c" ];
    ...
    node_11 [ label=<h>, fontcolor="#a42af4", shape=plain ];
