digraph bill {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>bar</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_7 {
      peripheries=0;
      node_7 [ label=<<table border='0'><tr><td>number</td></tr></table>>, color="black" ];
    };
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_10 [ label=<<table border='0'><tr><td>foo</td></tr></table>>, color="black", shape="box" ];
    ...
    subgraph cluster_alt_12 {
      peripheries=0;
      node_12 [ label=<<table border='0'><tr><td>add</td></tr></table>>, color="green" ];
      node_13 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
      node_12 -> node_13 [ arrowhead=none ];
      node_14 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_18 [ label=<<table border='0'><tr><td>bar</td></tr></table>>, color="black", shape="box" ];
    ...
    subgraph cluster_alt_20 {
      peripheries=0;
      node_20 [ label=<<table border='0'><tr><td>mult</td></tr></table>>, color="green" ];
      node_21 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
      node_20 -> node_21 [ arrowhead=none ];
      node_22 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="black" ];
      node_20 -> node_22 [ arrowhead=none ];
      node_23 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
      node_20 -> node_23 [ arrowhead=none ];
    };
    node_24 [ label=<hx>, fontcolor="purple", shape=plain ];
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_26 [ label=<<table border='0'><tr><td>number</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_28 {
      peripheries=0;
      node_28 [ label=<<table border='0'><tr><td>f</td></tr></table>>, color="green" ];
      node_29 [ label=<<table border='0'><tr><td>INT</td></tr></table>>, color="blue" ];
  ...
  subgraph cluster_5 {
    peripheries=1;
    label="";
    node_31 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black", shape="box", style="dotted" ];
  ...
  subgraph cluster_6 {
    peripheries=1;
    label="";
    node_34 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="black", shape="box" ];
