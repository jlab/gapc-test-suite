digraph gra_bst {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>entry</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3, style="dotted" ];
    node_1 -> node_2 [ style="invis", weight=99 ];
    node_2 [ label=<<table border='0'><tr><td><font point-size='30'>&rarr;</font></td></tr></table>>, shape=plaintext ];
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>tcase</td></tr></table>>, color="#14fe14" ];
      node_4 [ label=<<table border='0'><tr><td>INT</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_6 {
      peripheries=0;
      node_6 [ label=<<table border='0'><tr><td>keypair</td></tr></table>>, color="#14fe14" ];
      node_7 [ label=<<table border='0'><tr><td>FLOAT</td></tr></table>>, color="#0402fc" ];
