digraph affinelocsim {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      ...
      node_7 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_9 {
      peripheries=0;
      node_9 [ label=<<table border='0'><tr><td>ins</td></tr></table>>, color="green" ];
      ...
      node_13 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_15 {
      peripheries=0;
      node_15 [ label=<<table border='0'><tr><td>del</td></tr></table>>, color="green" ];
      ...
      node_19 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_21 {
      ...
      subgraph cluster_node_22 {
        peripheries=1;
        node_23 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="blue" ];
