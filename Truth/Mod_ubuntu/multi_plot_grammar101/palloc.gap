digraph pal {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_7 {
      peripheries=0;
      node_7 [ label=<<table border='0'><tr><td>sr</td></tr></table>>, color="black" ];
    };
  ...
  subgraph cluster_2 {
    ...
    subgraph cluster_alt_14 {
      peripheries=0;
      node_14 [ label=<<table border='0'><tr><td>skipr</td></tr></table>>, color="green" ];
      node_15 [ label=<<table border='0'><tr><td>sr</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_3 {
    ...
    subgraph cluster_alt_24 {
      ...
      node_27 [ label=<<table border='0'><tr><td>pl</td></tr></table>>, color="black" ];
