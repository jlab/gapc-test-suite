...
subgraph cluster_2{
    ...
    node_15 -> node_18 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_3{
    ...
    node_20 -> node_22 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_4{
    ...
    node_24 -> node_26 [ arrowhead=none, color="purple", weight=99, style=invis ];
