digraph nussinov {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>split</td></tr></table>>, color="green" ];
      node_4 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="black" ];
      node_3 -> node_4 [ arrowhead=none ];
      node_5 [ label=<<table border='0'><tr><td>pair</td></tr></table>>, color="green" ];
    ...
    subgraph cluster_alt_11 {
      peripheries=0;
      node_11 [ label=<<table border='0'><tr><td>right</td></tr></table>>, color="green" ];
    ...
    subgraph cluster_alt_15 {
      peripheries=0;
      node_15 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="green" ];
