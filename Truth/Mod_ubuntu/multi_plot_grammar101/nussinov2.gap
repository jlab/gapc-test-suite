digraph nussinov {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3 ];
    node_1 -> node_2 [ style="invis", weight=99 ];
    node_2 [ label=<<table border='0'><tr><td><font point-size='30'>&rarr;</font></td></tr></table>>, shape=plaintext ];
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>split</td></tr></table>>, color="#14fe14" ];
      node_4 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c" ];
      node_3 -> node_4 [ arrowhead=none ];
      node_5 [ label=<<table border='0'><tr><td>pair</td></tr></table>>, color="#14fe14" ];
      node_6 [ label="char_basepairing" , fontcolor="#fc02fc" , shape=none ];
      node_5 -> node_6 [ arrowhead=none, color="#fc02fc" ];
      node_7 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
      node_5 -> node_7 [ arrowhead=none ];
      node_8 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_11 {
      peripheries=0;
      node_11 [ label=<<table border='0'><tr><td>right</td></tr></table>>, color="#14fe14" ];
      node_12 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_15 {
      peripheries=0;
      node_15 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="#14fe14" ];
