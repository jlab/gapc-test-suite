...
subgraph cluster_9 {
    node_88 [ label=<<table border='0'><tr><td>motif__LJ</td></tr></table>>, color="black", shape="box" ];
...
subgraph cluster_15 {
    node_163 [ label=<<table border='0'><tr><td>left_unpairedEnd</td></tr></table>>, color="black", shape="box" ];
...
subgraph cluster_16 {
    node_175 [ label=<<table border='0'><tr><td>left_unpaired__LJ</td></tr></table>>, color="black", shape="box" ];
...
subgraph cluster_17 {
    node_185 [ label=<<table border='0'><tr><td>left_dangle__LJ</td></tr></table>>, color="black", shape="box" ];
...
subgraph cluster_18 {
    node_201 [ label=<<table border='0'><tr><td>noleft_dangle__LJ</td></tr></table>>, color="black", shape="box" ];
