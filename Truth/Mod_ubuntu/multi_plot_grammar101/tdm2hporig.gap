digraph canonicals_nonamb {
  ...
  subgraph cluster_9 {
    peripheries=1;
    label="";
    node_90 [ label=<<table border='0'><tr><td>motif__LJ</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_15 {
    peripheries=1;
    label="";
    node_165 [ label=<<table border='0'><tr><td>left_unpairedEnd</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_16 {
    peripheries=1;
    label="";
    node_177 [ label=<<table border='0'><tr><td>left_unpaired__LJ</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_17 {
    peripheries=1;
    label="";
    node_188 [ label=<<table border='0'><tr><td>left_dangle__LJ</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_18 {
    peripheries=1;
    label="";
    node_203 [ label=<<table border='0'><tr><td>noleft_dangle__LJ</td></tr></table>>, color="#0c0a0c", shape="box" ];
