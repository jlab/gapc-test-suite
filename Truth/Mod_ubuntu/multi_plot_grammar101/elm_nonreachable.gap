...
newrank=True;
ordering=out;
subgraph cluster_0x55a23c015a30{
...
subgraph cluster_0x55a23c015a50{
...
subgraph cluster_0x55a23c015b30{
...
subgraph cluster_0x55a23c015ba0{
node_22 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="black", shape="box", style="dotted" ];
