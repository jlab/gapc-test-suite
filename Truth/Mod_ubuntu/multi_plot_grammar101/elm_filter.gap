...
subgraph cluster_2{
    ...
    node_16 -> node_19 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_3{
    ...
    node_21 -> node_23 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_4{
    ...
    node_25 -> node_27 [ arrowhead=none, color="purple", weight=99, style=invis ];
