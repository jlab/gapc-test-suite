digraph bill {
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_18 [ label=<<table border='0'><tr><td>number</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_26 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="#0c0a0c", shape="box" ];
