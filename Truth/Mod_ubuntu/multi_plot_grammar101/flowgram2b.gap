digraph flow {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      ...
      subgraph cluster_node_4 {
        peripheries=1;
        node_5 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_8 {
      ...
      subgraph cluster_node_9 {
        ...
        node_11 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_13 {
      ...
      subgraph cluster_node_14 {
        ...
        node_16 [ label=<<table border='0'><tr><td>gap_1</td></tr></table>>, color="#0c0a0c" ];
        node_15 -> node_16 [ style="invis" ];
      };
      node_13 -> node_15 [ arrowhead=none , lhead=cluster_node_14 ];
      node_17 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_19 {
      peripheries=0;
      node_19 [ label=<<table border='0'><tr><td>del</td></tr></table>>, color="#14fe14" ];
      subgraph cluster_node_20 {
        peripheries=1;
        node_21 [ label=<<table border='0'><tr><td>gap</td></tr></table>>, color="#0c0a0c" ];
      ...
      node_23 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_25 {
      peripheries=0;
      node_25 [ label=<<table border='0'><tr><td>r</td></tr></table>>, color="#14fe14" ];
      ...
      node_29 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_31 {
      peripheries=0;
      node_31 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="#14fe14" ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_37 [ label=<<table border='0'><tr><td>gap</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_43 [ label=<<table border='0'><tr><td>gap_1</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
