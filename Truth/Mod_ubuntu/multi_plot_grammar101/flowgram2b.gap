  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      ...
      subgraph cluster_node_4 {
        peripheries=1;
        node_5 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="blue" ];
    ...
    subgraph cluster_alt_8 {
      ...
      subgraph cluster_node_9 {
        ...
        node_11 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="blue" ];
    ...
    subgraph cluster_alt_13 {
      ...
      subgraph cluster_node_14 {
        ...
        node_16 [ label=<<table border='0'><tr><td>gap_1</td></tr></table>>, color="black" ];
        node_15 -> node_16 [ style="invis" ];
      };
      node_13 -> node_15 [ arrowhead=none , lhead=cluster_node_14 ];
      node_17 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_19 {
      peripheries=0;
      node_19 [ label=<<table border='0'><tr><td>del</td></tr></table>>, color="green" ];
      subgraph cluster_node_20 {
        peripheries=1;
        node_21 [ label=<<table border='0'><tr><td>gap</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_25 {
      ...
      node_29 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="black" ];
