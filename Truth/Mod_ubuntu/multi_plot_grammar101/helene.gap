digraph fold {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>helene</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3, style="dotted" ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_8 [ label=<<table border='0'><tr><td>closed</td></tr></table>>, color="#0c0a0c", shape="box" ];
