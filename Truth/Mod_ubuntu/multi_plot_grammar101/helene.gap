...
subgraph cluster_1{
    ...
    node_1 -> node_6 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_3{
    ...
    node_18 -> node_23 [ arrowhead=none, color="purple", weight=99, style=invis ];
...
subgraph cluster_4{
    ...
    node_25 -> node_34 [ arrowhead=none, color="purple", weight=99, style=invis ];
