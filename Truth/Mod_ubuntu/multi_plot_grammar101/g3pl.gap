...
subgraph cluster_3 {
    ...
    node_46 [ label=<<table border='0'><tr><td>r1</td></tr></table>>, color="green" ];
    ...
    node_52 [ label=<<table border='0'><tr><td>r2</td></tr></table>>, color="green" ];
    ...
    node_55 [ label=<<table border='0'><tr><td>pair</td></tr></table>>, color="black" ];
...
subgraph cluster_4 {
    ...
    node_61 [ label=<<table border='0'><tr><td>t1</td></tr></table>>, color="green" ];
    node_62 [ label=<<table border='0'><tr><td>LOC</td></tr></table>>, color="blue" ];
    node_61 -> node_62 [ arrowhead=none ];
    node_63 [ label=<<table border='0'><tr><td>t</td></tr></table>>, color="black" ];
    ...
    node_67 [ label=<<table border='0'><tr><td>t2</td></tr></table>>, color="green" ];
    node_68 [ label=<<table border='0'><tr><td>LOC</td></tr></table>>, color="blue" ];
    node_67 -> node_68 [ arrowhead=none ];
    node_69 [ label=<<table border='0'><tr><td>t</td></tr></table>>, color="black" ];
    ...
    node_73 [ label=<<table border='0'><tr><td>t3</td></tr></table>>, color="green" ];
    ...
    node_76 [ label=<<table border='0'><tr><td>LOC</td></tr></table>>, color="blue" ];
    ...
    node_78 [ label=<<table border='0'><tr><td>t4</td></tr></table>>, color="green" ];
    node_79 [ label=<<table border='0'><tr><td>LOC</td></tr></table>>, color="blue" ];
    node_78 -> node_79 [ arrowhead=none ];
    node_80 [ label=<<table border='0'><tr><td>pair</td></tr></table>>, color="black" ];
