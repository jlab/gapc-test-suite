digraph affinelocsim {
  ...
  subgraph cluster_2 {
    ...
    subgraph cluster_alt_14 {
      peripheries=0;
      node_14 [ label=<<table border='0'><tr><td>sl</td></tr></table>>, color="green" ];
  ...
  subgraph cluster_3 {
    ...
    subgraph cluster_alt_21 {
      ...
      node_23 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
      node_21 -> node_23 [ arrowhead=none ];
      node_24 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
    ...
    subgraph cluster_alt_30 {
      peripheries=0;
      node_30 [ label=<<table border='0'><tr><td>del</td></tr></table>>, color="green" ];
      node_31 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
      node_30 -> node_31 [ arrowhead=none ];
      node_32 [ label=<<table border='0'><tr><td>xDel</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_34 {
      peripheries=0;
      node_34 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="green" ];
      node_35 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="blue" ];
  ...
  subgraph cluster_4 {
    ...
    subgraph cluster_alt_40 {
      peripheries=0;
      node_40 [ label=<<table border='0'><tr><td>delx</td></tr></table>>, color="green" ];
      node_41 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
      node_40 -> node_41 [ arrowhead=none ];
      node_42 [ label=<<table border='0'><tr><td>xDel</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_44 {
      peripheries=0;
      node_44 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
    };
  ...
  subgraph cluster_5 {
    ...
    subgraph cluster_alt_49 {
      peripheries=0;
      node_49 [ label=<<table border='0'><tr><td>insx</td></tr></table>>, color="green" ];
      node_50 [ label=<<table border='0'><tr><td>xIns</td></tr></table>>, color="black" ];
      node_49 -> node_50 [ arrowhead=none ];
      node_51 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
    ...
    subgraph cluster_alt_53 {
      peripheries=0;
      node_53 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
    };
