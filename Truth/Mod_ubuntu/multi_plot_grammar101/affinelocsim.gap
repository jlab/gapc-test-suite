...
subgraph cluster_2 {
    node_9 [ label=<<table border='0'><tr><td>skipL</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_11 [ label=<<table border='0'><tr><td>sl</td></tr></table>>, color="green" ];
    node_12 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
    node_11 -> node_12 [ arrowhead=none ];
    node_13 [ label=<<table border='0'><tr><td>skipL</td></tr></table>>, color="black" ];
...
subgraph cluster_3 {
    node_17 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black", shape="box" ];
    ...
    node_20 [ label=<<table border='0'><tr><td>SEQ</td></tr></table>>, color="blue" ];
    ...
    node_22 [ label=<<table border='0'><tr><td>del</td></tr></table>>, color="green" ];
    node_23 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
    node_22 -> node_23 [ arrowhead=none ];
    node_24 [ label=<<table border='0'><tr><td>xDel</td></tr></table>>, color="black" ];
    ...
    node_27 [ label=<<table border='0'><tr><td>xIns</td></tr></table>>, color="black" ];
    ...
    node_30 [ label=<<table border='0'><tr><td>match</td></tr></table>>, color="green" ];
    node_31 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
    node_30 -> node_31 [ arrowhead=none ];
    node_32 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
...
subgraph cluster_4 {
    node_35 [ label=<<table border='0'><tr><td>xDel</td></tr></table>>, color="black", shape="box" ];
    ...
    node_37 [ label=<<table border='0'><tr><td>alignment</td></tr></table>>, color="black" ];
    ...
    node_39 [ label=<<table border='0'><tr><td>delx</td></tr></table>>, color="green" ];
    node_40 [ label=<<table border='0'><tr><td>CHAR_SEP</td></tr></table>>, color="blue" ];
...
subgraph cluster_5 {
    node_43 [ label=<<table border='0'><tr><td>xIns</td></tr></table>>, color="black", shape="box" ];
    ...
    node_47 [ label=<<table border='0'><tr><td>insx</td></tr></table>>, color="green" ];
    node_48 [ label=<<table border='0'><tr><td>xIns</td></tr></table>>, color="black" ];
