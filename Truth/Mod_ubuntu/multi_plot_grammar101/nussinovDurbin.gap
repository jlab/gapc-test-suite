digraph durbin {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>pair</td></tr></table>>, color="#14fe14" ];
      ...
      node_6 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_9 {
      peripheries=0;
      node_9 [ label=<<table border='0'><tr><td>split</td></tr></table>>, color="#14fe14" ];
      node_10 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_15 {
      peripheries=0;
      node_15 [ label=<<table border='0'><tr><td>left</td></tr></table>>, color="#14fe14" ];
      node_16 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
      node_15 -> node_16 [ arrowhead=none ];
      node_17 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_19 {
      peripheries=0;
      node_19 [ label=<<table border='0'><tr><td>right</td></tr></table>>, color="#14fe14" ];
    ...
    subgraph cluster_alt_23 {
      peripheries=0;
      node_23 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="#14fe14" ];
