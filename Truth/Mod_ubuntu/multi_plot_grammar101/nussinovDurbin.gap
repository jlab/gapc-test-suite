...
subgraph cluster_1 {
    ...
    node_10 [ label=<<table border='0'><tr><td>left</td></tr></table>>, color="green" ];
    ...
    node_20 [ label=<<table border='0'><tr><td>pair</td></tr></table>>, color="green" ];
    ...
    node_23 [ label=<<table border='0'><tr><td>start</td></tr></table>>, color="black" ];
