digraph Grammar {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>A</td></tr></table>>, color="#0c0a0c" ];
    };
    node_4 [ label=<h1>, fontcolor="#a42af4", shape=plain ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_6 [ label=<<table border='0'><tr><td>A</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_8 {
      peripheries=0;
      node_8 [ label=<<table border='0'><tr><td>f</td></tr></table>>, color="#14fe14" ];
      node_9 [ label=<<table border='0'><tr><td>B</td></tr></table>>, color="#0c0a0c" ];
      node_8 -> node_9 [ arrowhead=none ];
    };
    node_10 [ label=<h1>, fontcolor="#a42af4", shape=plain ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_12 [ label=<<table border='0'><tr><td>B</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_14 {
      peripheries=0;
      node_14 [ label=<<table border='0'><tr><td>g</td></tr></table>>, color="#14fe14" ];
      node_15 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
    ...
    node_17 [ label=<h2>, fontcolor="#a42af4", shape=plain ];
