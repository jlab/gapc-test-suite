digraph flow {
  ...
  subgraph cluster_1 {
    peripheries=1;
    label="";
    node_1 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3 ];
    node_1 -> node_2 [ style="invis", weight=99 ];
    node_2 [ label=<<table border='0'><tr><td><font point-size='30'>&rarr;</font></td></tr></table>>, shape=plaintext ];
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>td</td></tr></table>>, color="#14fe14" ];
      subgraph cluster_node_4 {
        peripheries=1;
        node_5 [ label=<<table border='0'><tr><td>SEQ1</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_8 {
      peripheries=0;
      node_8 [ label=<<table border='0'><tr><td>ti</td></tr></table>>, color="#14fe14" ];
      subgraph cluster_node_9 {
        peripheries=1;
        node_10 [ label=<<table border='0'><tr><td>EMPTY</td></tr></table>>, color="#0402fc" ];
        node_11 [ label=<<table border='0'><tr><td>SEQ1</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_13 {
      peripheries=0;
      node_13 [ label=<<table border='0'><tr><td>ins</td></tr></table>>, color="#14fe14" ];
      ...
      subgraph cluster_node_20 {
        peripheries=1;
        node_21 [ label=<<table border='0'><tr><td>EMPTY</td></tr></table>>, color="#0402fc" ];
      ...
      node_26 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_28 {
      peripheries=0;
      node_28 [ label=<<table border='0'><tr><td>del</td></tr></table>>, color="#14fe14" ];
      subgraph cluster_node_29 {
        peripheries=1;
        node_30 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
        node_31 [ label=<<table border='0'><tr><td>EMPTY</td></tr></table>>, color="#0402fc" ];
        node_30 -> node_31 [ style="invis" ];
      };
      node_28 -> node_30 [ arrowhead=none , lhead=cluster_node_29 ];
      subgraph cluster_node_32 {
        peripheries=1;
        node_33 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
        node_34 [ label=<<table border='0'><tr><td>EMPTY</td></tr></table>>, color="#0402fc" ];
        node_33 -> node_34 [ style="invis" ];
      };
      node_28 -> node_33 [ arrowhead=none , lhead=cluster_node_32 ];
      subgraph cluster_node_35 {
        peripheries=1;
        node_36 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
        node_37 [ label=<<table border='0'><tr><td>EMPTY</td></tr></table>>, color="#0402fc" ];
      ...
      node_41 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_43 {
      peripheries=0;
      node_43 [ label=<<table border='0'><tr><td>r</td></tr></table>>, color="#14fe14" ];
      subgraph cluster_node_44 {
        peripheries=1;
        node_45 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
        node_46 [ label=<<table border='0'><tr><td>CHAR</td></tr></table>>, color="#0402fc" ];
        node_45 -> node_46 [ style="invis" ];
      };
      node_43 -> node_45 [ arrowhead=none , lhead=cluster_node_44 ];
      node_47 [ label=<<table border='0'><tr><td>ali</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_49 {
      peripheries=0;
      node_49 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="#14fe14" ];
      subgraph cluster_node_50 {
        peripheries=1;
        node_51 [ label=<<table border='0'><tr><td>EMPTY</td></tr></table>>, color="#0402fc" ];
