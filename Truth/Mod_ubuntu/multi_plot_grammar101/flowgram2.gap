...
newrank=True;
ordering=out;
subgraph cluster_0x560ca2871ae0{
...
node_2 -> node_4 [ arrowhead=none , lhead=cluster_node_0x560ca28a0fbc ];
...
node_6 -> node_8 [ arrowhead=none , lhead=cluster_node_0x560ca288b9bc ];
...
node_11 -> node_13 [ arrowhead=none , lhead=cluster_node_0x560ca28a3cfc ];
...
node_11 -> node_16 [ arrowhead=none , lhead=cluster_node_0x560ca28a3d9c ];
...
node_11 -> node_19 [ arrowhead=none , lhead=cluster_node_0x560ca28a3e3c ];
...
node_11 -> node_22 [ arrowhead=none , lhead=cluster_node_0x560ca28a3edc ];
...
node_25 -> node_27 [ arrowhead=none , lhead=cluster_node_0x560ca28a400c ];
...
node_25 -> node_30 [ arrowhead=none , lhead=cluster_node_0x560ca28a40ac ];
...
node_25 -> node_33 [ arrowhead=none , lhead=cluster_node_0x560ca28a414c ];
...
node_25 -> node_36 [ arrowhead=none , lhead=cluster_node_0x560ca28a41ec ];
...
node_39 -> node_41 [ arrowhead=none , lhead=cluster_node_0x560ca28a433c ];
...
node_43 -> node_45 [ arrowhead=none , lhead=cluster_node_0x560ca28a449c ];
