digraph stefansDangle {
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_10 [ label=<<table border='0'><tr><td>hlcons</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_24 [ label=<<table border='0'><tr><td>mlcons</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_40 [ label=<<table border='0'><tr><td>component</td></tr></table>>, color="#0c0a0c", shape="box" ];
  ...
  subgraph cluster_6 {
    peripheries=1;
    label="";
    node_73 [ label=<<table border='0'><tr><td>stem</td></tr></table>>, color="#0c0a0c", shape="box" ];
