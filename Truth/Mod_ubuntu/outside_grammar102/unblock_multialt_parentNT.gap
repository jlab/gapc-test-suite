digraph gra_nodangle {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_6 {
      ...
      node_6 -> node_10 [ ];
      node_13 [ label=<<table border='0'><tr><td>weak</td></tr></table>>, color="black" ];
      node_6 -> node_13 [ ];
    };
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_16 [ label=<<table border='0'><tr><td>weak</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_18 {
      peripheries=0;
      node_18 [ label=<<table border='0'><tr><td>a block</td></tr></table>>, color="gray" ];
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_32 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_34 {
      peripheries=0;
      node_34 [ label=<<table border='0'><tr><td>outside_weak</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_36 {
      peripheries=0;
      node_36 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="green" ];
      node_37 [ label=<<table border='0'><tr><td>BASE</td></tr></table>>, color="blue" ];
      node_36 -> node_37 [ arrowhead=none ];
      node_38 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
      node_36 -> node_38 [ arrowhead=none ];
    };
    node_39 [ label=<h>, fontcolor="purple", shape=plain ];
  ...
  subgraph cluster_5 {
    peripheries=1;
    label="";
    node_41 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_46 {
      peripheries=0;
      node_46 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="green" ];
      node_47 [ label=<<table border='0'><tr><td>BASE</td></tr></table>>, color="blue" ];
      node_46 -> node_47 [ arrowhead=none ];
      node_48 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_6 {
    peripheries=1;
    label="";
    node_51 [ label=<<table border='0'><tr><td>outside_weak</td></tr></table>>, color="black", shape="box", style="dotted" ];
