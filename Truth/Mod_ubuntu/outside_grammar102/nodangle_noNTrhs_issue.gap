...
subgraph cluster_2 {
    node_6 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_8 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="green" ];
...
subgraph cluster_3 {
    node_17 [ label=<<table border='0'><tr><td>outside_start</td></tr></table>>, color="black", shape="box", style="dotted" ];
...
subgraph cluster_4 {
    node_22 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
    ...
    node_24 [ label=<<table border='0'><tr><td>incl</td></tr></table>>, color="green" ];
    node_25 [ label=<<table border='0'><tr><td>outside_start</td></tr></table>>, color="black" ];
    ...
    node_27 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="green" ];
