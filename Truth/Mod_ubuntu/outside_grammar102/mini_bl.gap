digraph gra_nodangle {
  ...
  subgraph cluster_2 {
    ...
    subgraph cluster_alt_11 {
      ...
      node_16 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="#0c0a0c" ];
      node_11 -> node_16 [ arrowhead=none ];
      node_17 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_22 [ label=<<table border='0'><tr><td>outside_iloop</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_24 {
      peripheries=0;
      node_24 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="#0c0a0c" ];
    };
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_27 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3, style="dotted" ];
    ...
    subgraph cluster_alt_32 {
      peripheries=0;
      node_32 [ label=<<table border='0'><tr><td>il</td></tr></table>>, color="#14fe14" ];
      ...
      node_35 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
      ...
      node_37 [ label=<<table border='0'><tr><td>outside_iloop</td></tr></table>>, color="#0c0a0c" ];
