...
subgraph cluster_1 {
    ...
    node_6 [ label=<<table border='0'><tr><td>incl</td></tr></table>>, color="green" ];
    ...
    node_15 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="green" ];
...
subgraph cluster_4 {
    node_36 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_38 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="green" ];
    ...
    node_49 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
    ...
    node_52 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
...
subgraph cluster_5 {
    node_58 [ label=<<table border='0'><tr><td>outside_axioms</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
