...
subgraph cluster_1 {
    ...
    node_8 [ label=<<table border='0'><tr><td>hairpin</td></tr></table>>, color="black" ];
...
subgraph cluster_2 {
    node_14 [ label=<<table border='0'><tr><td>hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_16 [ label=<<table border='0'><tr><td>hl</td></tr></table>>, color="green" ];
...
subgraph cluster_3 {
    node_24 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_26 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
    node_27 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
    node_26 -> node_27 [ arrowhead=none ];
    node_28 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
...
subgraph cluster_4 {
    node_30 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_32 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="green" ];
    ...
    node_37 [ label=<<table border='0'><tr><td>hairpin</td></tr></table>>, color="black" ];
...
subgraph cluster_5 {
    node_43 [ label=<<table border='0'><tr><td>outside_axioms</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
    ...
    node_45 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
    ...
    node_47 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black" ];
