...
subgraph cluster_53 {
    ...
    node_837 [ label=<<table border='0'><tr><td>outside_left_dangle</td></tr></table>>, color="black" ];
    ...
    node_839 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black" ];
