digraph canonicals_nonamb {
  ...
  subgraph cluster_53 {
    ...
    subgraph cluster_alt_867 {
      peripheries=0;
      node_867 [ label=<<table border='0'><tr><td>outside_left_dangle</td></tr></table>>, color="#0c0a0c" ];
    };
    ...
    subgraph cluster_alt_869 {
      peripheries=0;
      node_869 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="#0c0a0c" ];
    };
