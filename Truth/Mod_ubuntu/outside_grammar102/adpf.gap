digraph fold {
  ...
  subgraph cluster_13 {
    ...
    subgraph cluster_alt_176 {
      ...
      node_177 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
      node_176 -> node_177 [ arrowhead=none ];
      node_178 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_22 {
    ...
    subgraph cluster_alt_267 {
      peripheries=0;
      node_267 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
      node_268 [ label=<<table border='0'><tr><td>dangle</td></tr></table>>, color="black" ];
