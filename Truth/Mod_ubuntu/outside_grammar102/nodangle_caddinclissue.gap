...
subgraph cluster_1 {
    ...
    node_8 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
    node_9 [ label=<<table border='0'><tr><td>incl</td></tr></table>>, color="green" ];
    node_10 [ label=<<table border='0'><tr><td>dangle</td></tr></table>>, color="black" ];
...
subgraph cluster_3 {
    node_24 [ label=<<table border='0'><tr><td>hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
...
subgraph cluster_4 {
    node_35 [ label=<<table border='0'><tr><td>outside_dangle</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_37 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
    node_38 [ label=<<table border='0'><tr><td>incl</td></tr></table>>, color="green" ];
    node_39 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
    node_38 -> node_39 [ arrowhead=none ];
    node_37 -> node_38 [ arrowhead=none ];
    node_40 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
...
subgraph cluster_5 {
    node_43 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_45 [ label=<<table border='0'><tr><td>drem</td></tr></table>>, color="green" ];
    node_46 [ label=<<table border='0'><tr><td>LOC</td></tr></table>>, color="blue" ];
    node_45 -> node_46 [ arrowhead=none ];
    node_47 [ label=<<table border='0'><tr><td>outside_dangle</td></tr></table>>, color="black" ];
    node_45 -> node_47 [ arrowhead=none ];
    node_48 [ label=<<table border='0'><tr><td>LOC</td></tr></table>>, color="blue" ];
...
subgraph cluster_6 {
    node_50 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_55 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
    ...
    node_62 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
...
subgraph cluster_7 {
    node_66 [ label=<<table border='0'><tr><td>outside_axioms</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
    ...
    node_68 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black" ];
    ...
    node_70 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
