digraph gra_nodangle {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      peripheries=0;
      node_3 [ label=<<table border='0'><tr><td>ssadd</td></tr></table>>, color="#14fe14" ];
    ...
    subgraph cluster_alt_11 {
      peripheries=0;
      node_11 [ label=<<table border='0'><tr><td>nil</td></tr></table>>, color="#14fe14" ];
      node_12 [ label=<<table border='0'><tr><td>LOC</td></tr></table>>, color="#0402fc" ];
  ...
  subgraph cluster_2 {
    peripheries=1;
    label="";
    node_15 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3, style="dotted" ];
    ...
    subgraph cluster_alt_20 {
      peripheries=0;
      node_20 [ label=<<table border='0'><tr><td>ssadd</td></tr></table>>, color="#14fe14" ];
      node_21 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
    ...
    subgraph cluster_alt_24 {
      peripheries=0;
      node_24 [ label=<<table border='0'><tr><td>sadd</td></tr></table>>, color="#14fe14" ];
