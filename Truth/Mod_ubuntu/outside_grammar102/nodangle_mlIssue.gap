...
subgraph cluster_1 {
    ...
    node_7 [ label=<<table border='0'><tr><td>multiloop</td></tr></table>>, color="black" ];
...
subgraph cluster_2 {
    node_10 [ label=<<table border='0'><tr><td>hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_12 [ label=<<table border='0'><tr><td>hl</td></tr></table>>, color="green" ];
...
subgraph cluster_3 {
    node_20 [ label=<<table border='0'><tr><td>multiloop</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_22 [ label=<<table border='0'><tr><td>ml</td></tr></table>>, color="green" ];
...
subgraph cluster_4 {
    node_28 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_30 [ label=<<table border='0'><tr><td>ml</td></tr></table>>, color="green" ];
    ...
    node_33 [ label=<<table border='0'><tr><td>outside_multiloop</td></tr></table>>, color="black" ];
...
subgraph cluster_5 {
    node_36 [ label=<<table border='0'><tr><td>outside_multiloop</td></tr></table>>, color="black", shape="box", style="dotted" ];
...
subgraph cluster_6 {
    node_42 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_44 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
    node_45 [ label=<<table border='0'><tr><td>multiloop</td></tr></table>>, color="black" ];
...
subgraph cluster_7 {
    node_51 [ label=<<table border='0'><tr><td>outside_axioms</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
    ...
    node_53 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black" ];
