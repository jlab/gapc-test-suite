digraph gra_nodangle {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_3 {
      ...
      node_4 [ label=<<table border='0'><tr><td>multiloop</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_21 [ label=<<table border='0'><tr><td>multiloop</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_23 {
      peripheries=0;
      node_23 [ label=<<table border='0'><tr><td>ml</td></tr></table>>, color="green" ];
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_30 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_32 {
      peripheries=0;
      node_32 [ label=<<table border='0'><tr><td>ml</td></tr></table>>, color="green" ];
      ...
      node_35 [ label=<<table border='0'><tr><td>outside_multiloop</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_5 {
    peripheries=1;
    label="";
    node_39 [ label=<<table border='0'><tr><td>outside_multiloop</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_41 {
      peripheries=0;
      node_41 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
  ...
  subgraph cluster_6 {
    peripheries=1;
    label="";
    node_46 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    subgraph cluster_alt_48 {
      peripheries=0;
      node_48 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_51 {
      peripheries=0;
      node_51 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
      node_52 [ label=<<table border='0'><tr><td>multiloop</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_7 {
    peripheries=1;
    label="";
    node_56 [ label=<<table border='0'><tr><td>outside_axioms</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
    ...
    subgraph cluster_alt_60 {
      peripheries=0;
      node_60 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black" ];
    };
