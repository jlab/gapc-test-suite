digraph canonicals_nonamb {
  ...
  subgraph cluster_53 {
    ...
    subgraph cluster_alt_864 {
      peripheries=0;
      node_864 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_866 {
      peripheries=0;
      node_866 [ label=<<table border='0'><tr><td>outside_left_dangle</td></tr></table>>, color="black" ];
    };
