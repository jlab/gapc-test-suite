digraph bill {
  ...
  subgraph cluster_1 {
    ...
    subgraph cluster_alt_8 {
      ...
      node_10 [ label=<<table border='0'><tr><td>add</td></tr></table>>, color="green" ];
      node_11 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
      node_10 -> node_11 [ arrowhead=none ];
      node_12 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_15 {
      peripheries=0;
      node_15 [ label=<<table border='0'><tr><td>number</td></tr></table>>, color="black" ];
    };
  ...
  subgraph cluster_5 {
    ...
    subgraph cluster_alt_34 {
      peripheries=0;
      node_34 [ label=<<table border='0'><tr><td>mult</td></tr></table>>, color="green" ];
      node_35 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
      node_34 -> node_35 [ arrowhead=none ];
      node_36 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="black" ];
      node_34 -> node_36 [ arrowhead=none ];
      node_37 [ label=<<table border='0'><tr><td>outside_formula</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_39 {
      peripheries=0;
      node_39 [ label=<<table border='0'><tr><td>mult</td></tr></table>>, color="green" ];
      node_40 [ label=<<table border='0'><tr><td>outside_formula</td></tr></table>>, color="black" ];
      node_39 -> node_40 [ arrowhead=none ];
      node_41 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="black" ];
      node_39 -> node_41 [ arrowhead=none ];
      node_42 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_44 {
      peripheries=0;
      node_44 [ label=<<table border='0'><tr><td>add</td></tr></table>>, color="green" ];
      ...
      node_47 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black" ];
      node_44 -> node_47 [ arrowhead=none ];
      node_48 [ label=<<table border='0'><tr><td>outside_formula</td></tr></table>>, color="black" ];
    ...
    subgraph cluster_alt_50 {
      ...
      node_52 [ label=<<table border='0'><tr><td>outside_formula</td></tr></table>>, color="black" ];
      node_50 -> node_52 [ arrowhead=none ];
      node_53 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black" ];
      node_50 -> node_53 [ arrowhead=none ];
      node_54 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
  ...
  subgraph cluster_6 {
    peripheries=1;
    label="";
    node_57 [ label=<<table border='0'><tr><td>outside_number</td></tr></table>>, color="black", shape="box", penwidth=3 ];
    ...
    subgraph cluster_alt_59 {
      peripheries=0;
      node_59 [ label=<<table border='0'><tr><td>outside_formula</td></tr></table>>, color="black" ];
    };
