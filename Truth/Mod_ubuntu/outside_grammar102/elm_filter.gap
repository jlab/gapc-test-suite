...
subgraph cluster_5 {
    ...
    node_33 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="black" ];
    ...
    node_38 [ label=<<table border='0'><tr><td>times</td></tr></table>>, color="black" ];
    ...
    node_41 [ label=<<table border='0'><tr><td>add</td></tr></table>>, color="green" ];
    ...
    node_44 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black" ];
    node_41 -> node_44 [ arrowhead=none ];
    node_45 [ label=<<table border='0'><tr><td>formula</td></tr></table>>, color="black" ];
    ...
    node_47 [ label=<<table border='0'><tr><td>add</td></tr></table>>, color="green" ];
    ...
    node_50 [ label=<<table border='0'><tr><td>plus</td></tr></table>>, color="black" ];
