digraph gra_cpg {
  ...
  subgraph cluster_11 {
    ...
    subgraph cluster_alt_164 {
      peripheries=0;
      node_164 [ label=<<table border='0'><tr><td>outside_rich</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_166 {
      peripheries=0;
      node_166 [ label=<<table border='0'><tr><td>outside_rich_emission</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_168 {
      peripheries=0;
      node_168 [ label=<<table border='0'><tr><td>outside_poor</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_170 {
      peripheries=0;
      node_170 [ label=<<table border='0'><tr><td>outside_poor_emission</td></tr></table>>, color="black" ];
    };
