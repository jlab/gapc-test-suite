digraph gra_weather {
  ...
  subgraph cluster_11 {
    ...
    subgraph cluster_alt_151 {
      peripheries=0;
      node_151 [ label=<<table border='0'><tr><td>outside_emit_hoch</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_153 {
      peripheries=0;
      node_153 [ label=<<table border='0'><tr><td>outside_emit_tief</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_155 {
      peripheries=0;
      node_155 [ label=<<table border='0'><tr><td>outside_state_hoch</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_157 {
      peripheries=0;
      node_157 [ label=<<table border='0'><tr><td>outside_state_start</td></tr></table>>, color="black" ];
    };
    ...
    subgraph cluster_alt_159 {
      peripheries=0;
      node_159 [ label=<<table border='0'><tr><td>outside_state_tief</td></tr></table>>, color="black" ];
    };
