...
subgraph cluster_1 {
    ...
    node_7 [ label=<<table border='0'><tr><td>hairpin</td></tr></table>>, color="black" ];
...
subgraph cluster_3 {
    node_21 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_23 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
    node_24 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
    node_23 -> node_24 [ arrowhead=none ];
    node_25 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
...
subgraph cluster_4 {
    node_27 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", style="dotted" ];
    ...
    node_29 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
    node_30 [ label=<<table border='0'><tr><td>hairpin</td></tr></table>>, color="black" ];
    node_29 -> node_30 [ arrowhead=none ];
    node_31 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
    ...
    node_33 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
...
subgraph cluster_5 {
    node_36 [ label=<<table border='0'><tr><td>outside_axioms</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
    ...
    node_38 [ label=<<table border='0'><tr><td>outside_hairpin</td></tr></table>>, color="black" ];
