digraph gra_nodangle {
  ...
  subgraph cluster_2 {
    ...
    subgraph cluster_alt_11 {
      ...
      node_15 [ label=<<table border='0'><tr><td>comp</td></tr></table>>, color="#14fe14" ];
  ...
  subgraph cluster_3 {
    peripheries=1;
    label="";
    node_27 [ label=<<table border='0'><tr><td>outside_iloop</td></tr></table>>, color="#0c0a0c", shape="box", style="dotted" ];
  ...
  subgraph cluster_4 {
    peripheries=1;
    label="";
    node_32 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="#0c0a0c", shape="box", penwidth=3, style="dotted" ];
    ...
    subgraph cluster_alt_37 {
      peripheries=0;
      node_37 [ label=<<table border='0'><tr><td>il</td></tr></table>>, color="#14fe14" ];
      ...
      node_40 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
      node_37 -> node_40 [ arrowhead=none ];
      node_41 [ label=<<table border='0'><tr><td>comp</td></tr></table>>, color="#14fe14" ];
      ...
      node_45 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
      node_41 -> node_45 [ arrowhead=none ];
      node_46 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="#0c0a0c" ];
      ...
      node_48 [ label=<<table border='0'><tr><td>outside_iloop</td></tr></table>>, color="#0c0a0c" ];
    ...
    subgraph cluster_alt_52 {
      peripheries=0;
      node_52 [ label=<<table border='0'><tr><td>il</td></tr></table>>, color="#14fe14" ];
      ...
      node_56 [ label=<<table border='0'><tr><td>comp</td></tr></table>>, color="#14fe14" ];
      ...
      node_60 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
      node_56 -> node_60 [ arrowhead=none ];
      node_61 [ label=<<table border='0'><tr><td>outside_iloop</td></tr></table>>, color="#0c0a0c" ];
      node_56 -> node_61 [ arrowhead=none ];
      node_62 [ label=<<table border='0'><tr><td>BASE</td></tr></table>>, color="#0402fc" ];
      node_56 -> node_62 [ arrowhead=none ];
      node_63 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="#0c0a0c" ];
      node_56 -> node_63 [ arrowhead=none ];
      node_52 -> node_56 [ arrowhead=none ];
      node_64 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="#0402fc" ];
