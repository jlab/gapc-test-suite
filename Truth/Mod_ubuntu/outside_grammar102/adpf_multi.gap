digraph fold {
  ...
  subgraph cluster_11 {
    ...
    node_130 [ label=<ha>, fontcolor="#a42af4", shape=plain ];
  ...
  subgraph cluster_13 {
    ...
    subgraph cluster_alt_176 {
      ...
      node_177 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="#0c0a0c" ];
      node_176 -> node_177 [ arrowhead=none ];
      node_178 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="#0c0a0c" ];
  ...
  subgraph cluster_18 {
    ...
    node_244 [ label=<ha>, fontcolor="#a42af4", shape=plain ];
  ...
  subgraph cluster_22 {
    ...
    subgraph cluster_alt_267 {
      peripheries=0;
      node_267 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="#14fe14" ];
      node_268 [ label=<<table border='0'><tr><td>dangle</td></tr></table>>, color="#0c0a0c" ];
      node_267 -> node_268 [ arrowhead=none ];
      node_269 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="#0c0a0c" ];
