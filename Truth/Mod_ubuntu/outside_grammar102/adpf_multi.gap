...
subgraph cluster_13 {
    ...
    node_196 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black" ];
    node_195 -> node_196 [ arrowhead=none ];
    node_197 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
...
subgraph cluster_18 {
    ...
    node_243 [ label=<ha>, fontcolor="purple", shape=none ];
...
subgraph cluster_22 {
    ...
    node_266 [ label=<<table border='0'><tr><td>cadd</td></tr></table>>, color="green" ];
    node_267 [ label=<<table border='0'><tr><td>dangle</td></tr></table>>, color="black" ];
