...
subgraph cluster_4 {
    node_31 [ label=<<table border='0'><tr><td>outside_struct</td></tr></table>>, color="black", shape="box", penwidth=3, style="dotted" ];
    ...
    node_33 [ label=<<table border='0'><tr><td>il</td></tr></table>>, color="green" ];
    ...
    node_38 [ label=<<table border='0'><tr><td>comp</td></tr></table>>, color="green" ];
    ...
    node_42 [ label=<<table border='0'><tr><td>outside_iloop</td></tr></table>>, color="black" ];
    ...
    node_44 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
    ...
    node_49 [ label=<<table border='0'><tr><td>il</td></tr></table>>, color="green" ];
    ...
    node_54 [ label=<<table border='0'><tr><td>comp</td></tr></table>>, color="green" ];
    ...
    node_58 [ label=<<table border='0'><tr><td>struct</td></tr></table>>, color="black" ];
    ...
    node_60 [ label=<<table border='0'><tr><td>outside_iloop</td></tr></table>>, color="black" ];
    node_54 -> node_60 [ arrowhead=none ];
    node_61 [ label=<<table border='0'><tr><td>REGION</td></tr></table>>, color="blue" ];
