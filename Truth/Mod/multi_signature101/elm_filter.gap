...
formula ([Sig answer]) = NULL |
   [Sig answer]{ [Sig answer] add(Sig answer< [Sig answer] >, char< NULL >, Sig answer< [Sig answer] >, ) | }  |
...
formula ([Sig answer]) = [Sig answer] |
   [Sig answer]{ [Sig answer] add(Sig answer< [Sig answer] >, char< [char] >, Sig answer< [Sig answer] >, ) | }  |
